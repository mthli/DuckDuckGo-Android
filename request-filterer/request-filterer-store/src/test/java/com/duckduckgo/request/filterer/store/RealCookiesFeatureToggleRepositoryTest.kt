...
class RealCookiesFeatureToggleRepositoryTest {
    ...
    private val mockCookiesFeatureToggleStore: RequestFiltererFeatureToggleRepository = mock()

    @Before
    fun before() {
        testee = RealRequestFiltererFeatureToggleRepository(mockCookiesFeatureToggleStore)
    }
    ...
    fun whenGetThenGetCalled() {
        ...
        verify(mockCookiesFeatureToggleStore).get(RequestFilterer, true)
    }

    @Test
    fun whenInsertThenInsertCalled() {
        val cookieFeatureToggle = RequestFiltererFeatureToggles(RequestFilterer, true, null)
